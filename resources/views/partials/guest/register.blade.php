        ...
        <div class="row">
            <div class="col-12">
                <div class="title-sec">
                    ...
                    <h3>register to join lovers</h3>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="vector-section mb--65">
                    <img src="https://themes.pixelstrap.com/friendbook/assets/images/company-landing/feature-vector/register/phone.svg"
                         class="img-fluid blur-up lazyload main-img wow zoomIn" data-wow-delay="0.20s" alt="">
                    <img src="https://themes.pixelstrap.com/friendbook/assets/images/company-landing/feature-vector/register/lock.svg"
                         class="img-fluid blur-up lazyload lock-img wow zoomIn" data-wow-delay="0.30s" alt="">
                    <img src="https://themes.pixelstrap.com/friendbook/assets/images/company-landing/feature-vector/register/thumbs-up.svg"
                         class="img-fluid blur-up lazyload thumb-img wow zoomIn" data-wow-delay="0.40s" alt="">
                </div>
            </div>
            <div class="col-lg-6">
